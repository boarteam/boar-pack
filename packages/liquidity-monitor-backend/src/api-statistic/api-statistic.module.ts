...
export class ApiStatisticModule {
  static forRoot(config: { dataSourceName?: string; serviceName?: string }) {
    return {
      module: ApiStatisticModule,
      imports: [ScheduleModule, TypeOrmModule.forFeature([ApiStatistic], config.dataSourceName)],
      providers: [
        {
