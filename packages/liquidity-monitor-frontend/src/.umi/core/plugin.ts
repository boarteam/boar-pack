...
import * as Plugin_1 from '/Users/denisvolper/Projects/boar-pack/packages/liquidity-monitor-frontend/src/.umi/plugin-model/runtime.tsx';
...
export function getPlugins() {
  return [
    ...
    {
      apply: Plugin_1,
      path: process.env.NODE_ENV === 'production' ? void 0 : '/Users/denisvolper/Projects/boar-pack/packages/liquidity-monitor-frontend/src/.umi/plugin-model/runtime.tsx',
    },
  ];
}
