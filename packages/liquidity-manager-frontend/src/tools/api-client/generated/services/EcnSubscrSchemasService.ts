...
/* tslint:disable */
/* eslint-disable */
import type { DeleteManyDto } from '../models/DeleteManyDto';
...
import type { UpdateManyDto } from '../models/UpdateManyDto';
...
export class EcnSubscrSchemasService {
    ...
    public updateMany({
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/{worker}/liquidity/ecn-subscr-schemas/updateMany',
            path: {
                'worker': worker,
            },
            query: {
    ...
    public deleteMany({
        ...
        worker: string,
        requestBody: DeleteManyDto,
    }): CancelablePromise<Record<string, any>> {
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/{worker}/liquidity/ecn-subscr-schemas/deleteMany',
            path: {
                'worker': worker,
            },
            body: requestBody,
