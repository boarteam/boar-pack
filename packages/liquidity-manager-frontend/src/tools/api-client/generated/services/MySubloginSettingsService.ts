...
export class MySubloginSettingsService {
     ...
     * @throws ApiError
     */
    public getOneBaseMySubloginsSettingsControllerSubloginSettings({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/{worker}/liquidity/my-sublogins-settings/{usersSubAccountInstId}/{instrument}',
            path: {
     ...
     * @throws ApiError
     */
    public updateOneBaseMySubloginsSettingsControllerSubloginSettings({
        usersSubAccountInstId,
        instrument,
        worker,
        requestBody,
     ...
     * @throws ApiError
     */
    public deleteOneBaseMySubloginsSettingsControllerSubloginSettings({
        usersSubAccountInstId,
        instrument,
        worker,
    }: {
     ...
     * @throws ApiError
     */
    public getManyBaseMySubloginsSettingsControllerSubloginSettings({
        worker,
        fields,
        s,
        filter,
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/{worker}/liquidity/my-sublogins-settings',
            path: {
                'worker': worker,
            },
            query: {
     ...
     * @throws ApiError
     */
    public createOneBaseMySubloginsSettingsControllerSubloginSettings({
        worker,
        requestBody,
    }: {
        worker: string,
