...
import { TpAuthenticationService } from './services/TpAuthenticationService';
...
export class ApiClient {
    ...
    public readonly tpAuthentication: TpAuthenticationService;
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = NodeHttpRequest) {
        ...
        this.tpAuthentication = new TpAuthenticationService(this.request);
