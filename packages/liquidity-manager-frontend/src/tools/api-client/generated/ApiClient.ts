...
import { EcnInstrumentsHistoryService } from './services/EcnInstrumentsHistoryService';
...
import { EcnModulesHistoryService } from './services/EcnModulesHistoryService';
...
export class ApiClient {
    ...
    public readonly ecnInstrumentsHistory: EcnInstrumentsHistoryService;
    public readonly ecnMarginCalcModes: EcnMarginCalcModesService;
    public readonly ecnModules: EcnModulesService;
    public readonly ecnModulesHistory: EcnModulesHistoryService;
    ...
    public readonly usersHistory: UsersHistoryService;
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = NodeHttpRequest) {
        ...
        this.ecnInstrumentsHistory = new EcnInstrumentsHistoryService(this.request);
        this.ecnMarginCalcModes = new EcnMarginCalcModesService(this.request);
        this.ecnModules = new EcnModulesService(this.request);
        this.ecnModulesHistory = new EcnModulesHistoryService(this.request);
        ...
        this.usersHistory = new UsersHistoryService(this.request);
