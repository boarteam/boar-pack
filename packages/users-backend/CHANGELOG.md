...
## [8.1.1](https://github.com/boarteam/boar-pack/compare/@boarteam/boar-pack-users-backend@8.1.0...@boarteam/boar-pack-users-backend@8.1.1) (2026-02-26)
...
# [8.1.0](https://github.com/boarteam/boar-pack/compare/@boarteam/boar-pack-users-backend@7.1.0...@boarteam/boar-pack-users-backend@8.1.0) (2026-02-18)
...
* **backend settings and telegraf modules:** integrate Settings and Telegraf modules ([7a1681a](https://github.com/boarteam/boar-pack/commit/7a1681a0416a6b78849921ce2908a76b258a5d36))
...
* **telegraf service:** update sendMessage to support formatted strings and add validation for bot token and chat ID ([bc03726](https://github.com/boarteam/boar-pack/commit/bc03726d704237b8b1f83597bd730992faa94d9d))
* **telegram settings:** notifyAboutQuotesByProvider option for telegram settings ([e07a751](https://github.com/boarteam/boar-pack/commit/e07a751b869d23b2ed369740e6c625298b7a8e31))
...
* **EventLogs:** Service names are fetched from DB for event logs table filters ([9f02a3c](https://github.com/boarteam/boar-pack/commit/9f02a3cd934cc1d69e2b25ad45743fc29ba8a731))
...
* **users-backend:** Batch saving for logs ([#42](https://github.com/boarteam/boar-pack/issues/42)) ([8a8266f](https://github.com/boarteam/boar-pack/commit/8a8266f663395980fdcd1b87886ac184ffe71695))
