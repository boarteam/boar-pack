...
export class SettingsModule {
  static register(config: { withControllers: boolean; dataSourceName: string }): DynamicModule {
    return {
      module: SettingsModule,
      imports: [TypeOrmModule.forFeature([Setting], config.dataSourceName)],
      controllers: config.withControllers ? [SettingsController] : [],
      providers: [
        {
