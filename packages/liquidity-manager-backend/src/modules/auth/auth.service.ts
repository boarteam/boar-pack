...
export class AuthService {
  ...
  async validateUser(id: string, pass: string): Promise<TPUser | null> {
  ...
  async login(user: TPUser, rememberMe: boolean): Promise<LocalAuthTokenDto> {
  ...
  me(user: TPUser): Promise<UsersInst|null> {
  ...
  async resetPassword(user: TPUser, password: string): Promise<void> {
