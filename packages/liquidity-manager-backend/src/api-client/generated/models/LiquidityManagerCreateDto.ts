...
export type LiquidityManagerCreateDto = {
    name: string;
    host: string;
    port: number;
    enabled: boolean;
    ...
    pass: string;
    database: string;
    worker: LiquidityManagerCreateDto.worker;
    color: LiquidityManagerCreateDto.color;
};

export namespace LiquidityManagerCreateDto {
