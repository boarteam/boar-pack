...
export type LiquidityManagerUpdateDto = {
    name?: string;
    host?: string;
    port?: number;
    enabled?: boolean;
    ...
    pass?: string;
    database?: string;
    worker?: LiquidityManagerUpdateDto.worker;
    color?: LiquidityManagerUpdateDto.color;
};

export namespace LiquidityManagerUpdateDto {
